...
<body>
	...
	<div  class="box">
		...
		<br>
		<div id= "head">
			<div class="return"><a onclick="layer.msg('努力加载中',{icon:16,shade: 0.01,time:5000})" href="checkdetail.jsp" class="a">返回管理系统</a></div>
			<div class="select">
		...
		<table width="90%" class="table">
			...
			<c:forEach items="${list }" var="str" varStatus="st">
				...
				<td>${str.cstatus }</td>
				<td>${str.cdate }</td>
				<td><a onclick="layer.msg('努力加载中',{icon:16,shade: 0.01,time:5000})" href="daodeletecheckdetails.jsp?id=${str.cid}" class="anniu">删除</a></td>
				</tr>
			</c:forEach>
		</table>
		<br><br>
